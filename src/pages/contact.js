        ...
        <div className='md:container mx-auto flex justify-center items-center md:mt-32 mt-16 flex-col md:flex-row'>
            ...
            <div className='h-3/4 flex flex-col justify-around items-start space-y-12'>
              <div className='flex flex-row justify-start md:w-1/2'>
                <div className='text-center flex flex-col justify-center'>
                  <Image src='/images/contact/position.png' width={28} height={40} />
                </div>
                <div className='md:ml-20 ml-10 md:w-3/4'>
                  <div className='text-gray-400'>Address</div>
                  <div className='font-bold'>20-22 Wenlock Road London N1 7Gu</div>
                </div>
              </div>
              <div className='flex flex-row justify-start md:w-1/2'>
                <div className='text-center flex flex-col justify-center'>
                  <Image src='/images/contact/mail.png' width={32} height={22} />
                </div>
                <div className='md:ml-20 ml-10 md:w-3/4'>
              ...
              <div className='flex flex-row justify-start md:w-1/2'>
                <div className='text-center flex flex-col justify-center'>
                  <Image src='/images/contact/call.png' width={30} height={30} />
                </div>
                <div className='md:ml-20 ml-10 md:w-3/4'>
              ...
              <button className=' bg-purple text-gray-100 md:w-28 font-semibold py-1 px-2 rounded-full hover:opacity-90 focus:outline-none'>
                Book a Demo
              </button>
            </div>
          </div>
          ...
          <div className='md:w-1/2 mt-10 md:mt-0'>
            <div className='space-y-5 text-right md:px-20 px-10'>
              ...
              <button className='flex-shrink-0 bg-purple text-gray-100 w-20 text-lg font-semibold py-1 px-4 rounded-full hover:opacity-90 focus:outline-none'>
                Send
              </button>
            </div>
          </div>
